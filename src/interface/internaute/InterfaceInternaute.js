...
import ComponentConnexion from '../../Global/AuthPage/ComponentConnexion';
    ...
    <>
       ...
       <MobileIcon style={{borderRadius:"5px" , backgroundColor:"#32CD32"}} >
          ...
          <Sidebar  as={Menu}  animation='overlay' icon='labeled' inverted  onHide={() => setVisible(false)} vertical visible='true'  width='300px'>
            ...
            <Menu.Item as='a' href='#statistiques' name='statistiques'  active={activeItem === 'statistiques'}  onClick={() => setActiveItem("statistiques")} ><Icon name='dashboard'/> Statistique </Menu.Item>
            ...
            <Menu.Item as='a' href='#partenaires' name='partenaires'  active={activeItem === 'partenaires'}  onClick={() => setActiveItem("partenaires")}> <Icon name='list alternate outline'/>Partenaires</Menu.Item>
            <Menu.Item as='a' href='#equipe' name='equipe'  active={activeItem === 'equipe'}  onClick={() => setActiveItem("equipe")}> <Icon name='list alternate outline'/>Equipe</Menu.Item>
            ...
            <Menu.Item >  <ComponentConnexion/> </Menu.Item>
         </Container>
            </Sidebar>
            </Drawer>
          <Sidebar.Pushable>     
