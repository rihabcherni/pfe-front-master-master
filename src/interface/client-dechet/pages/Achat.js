                ...
                <div className='container2'>
                    ...
                    <div style={{height:"130px"}}>
                        {p.pourcentage_remise!==0 ?
                            <>
                                <li><b style={{color:"green", fontSize:"18px"}}>{(p.prix_unitaire -((p.prix_unitaire * p.pourcentage_remise)/100)).toFixed(3)} TND/KG</b></li>
                                <li style={{textDecoration: "line-through"}}>{p.prix_unitaire.toFixed(3)} TND/kG</li>
                            </>:<li><b style={{color:"green", fontSize:"18px"}}>{p.prix_unitaire.toFixed(3) } TND/KG</b></li>}
                        <li>dechet {p.type_dechet}</li>
