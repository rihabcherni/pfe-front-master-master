...
import FiltrageSituationTotaleEtablissement from './RevenuTotaleDechetCollecte/FiltrageSituationTotaleEtablissement';
import SituationTotaleMois from './RevenuTotaleDechetCollecte/SituationTotaleMois';
...
export default function TotaleSituation() {
  ...
  return (
    <div>
        ...
        <TabPanel value={value} index={1}>
            <FiltrageSituationTotaleEtablissement/>
        </TabPanel>
    </div>   
  )
}
