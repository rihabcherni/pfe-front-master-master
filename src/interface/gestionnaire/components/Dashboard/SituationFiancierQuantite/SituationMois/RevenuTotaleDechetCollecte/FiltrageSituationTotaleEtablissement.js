...
const FiltrageSituationTotaleEtablissement = () => {
  ...
  return (
    <> 
    <div style={{width:"20%", margin:"45px 20px -85px",fontSize:'12px' }}>
      ...
      <ChartFilterEtab url={`http://127.0.0.1:8000/api/revenu-totale-mois-filter/`+etab0}
      title={`Revenus des établissement en Dinars par mois en  `+ etab0}/>  
    </>
   
  );
}
export default FiltrageSituationTotaleEtablissement;