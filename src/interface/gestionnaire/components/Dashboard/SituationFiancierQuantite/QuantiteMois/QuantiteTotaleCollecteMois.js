...
const QuantiteTotaleCollecteMois = () => {
    ...
    return (
     <div>
      <Card>
        <Container>
          <StyledTypography style={{margin:"10px 0"}}>Quantité des déchets collectés dans tous les établissements par mois en KG en {annee} </StyledTypography>
          <div style={{width:"25%"}}>
...
export default QuantiteTotaleCollecteMois;